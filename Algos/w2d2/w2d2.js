...
class BinarySearchTree {
    ...
    contains(searchVal) {
        ...
        while (current) {
            //if searchVal is equal to the current node's data, return true
            if (current.data === searchVal) {
                return true;
                //if searchVal is less than current node's data make current equal current.left
            } else if (searchVal < current.data) {
                current = current.left;
                //if searchVal is greater than current node's data make current equal current.right
            } else {
                current = current.right;
            }
        }
